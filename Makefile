...
bind-rclone: go-bindata-download
	...
	@$(SEDCMD "s/package\ main/package\ rclone/" ./pkg/rclone/rclone_linux.go)
...
bind-rclone-windows: go-bindata-download
	...
	@$(SEDCMD "s/package\ main/package\ rclone/" ./pkg/rclone/rclone_windows.go)
...
bind-rclone-macos: go-bindata-download
	...
	@$(SEDCMD "s/package\\ main/package\\ rclone/" ./pkg/rclone/rclone_darwin.go)
