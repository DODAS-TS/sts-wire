...
```bash
wget https://github.com/DODAS-TS/sts-wire/releases/download/v1.0.6/sts-wire_linux
...
```bash
wget https://github.com/DODAS-TS/sts-wire/releases/download/v1.0.6/sts-wire_osx
...
Download the binary with the browser: [https://github.com/DODAS-TS/sts-wire/releases/download/v1.0.6/sts-wire_windows](https://github.com/DODAS-TS/sts-wire/releases/download/v1.0.6/sts-wire_windows)
